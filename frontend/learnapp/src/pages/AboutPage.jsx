...
export const About = () => {
    return (
        <Article>
            ...
            Поле «поиск» в хедере ищет слова как в английской раскладке, так и в русской, если ничего не найдено - возвращается null (путая страница).
            ...
            А так же можно было сделать получение карточек с бека рандомно, там их более 1700 штук, но задача была - фронт, и я не стал
            заморачиватья на беке.</Code>
